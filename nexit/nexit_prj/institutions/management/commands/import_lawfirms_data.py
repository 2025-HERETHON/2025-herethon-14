...
from institutions.models import LawFirm
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        for item in data:
            ...
            if not LawFirm.objects.filter(name=name, address=address).exists():
        ...
        self.stdout.write(self.style.SUCCESS("법무법인 데이터 저장 완료"))
