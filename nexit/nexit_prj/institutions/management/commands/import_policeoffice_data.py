...
from institutions.models import PoliceOffice
import requests
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        for item in data:
            ...
            # 중복 확인 (이름과 우편번호 기준)
            if not PoliceOffice.objects.filter(name=name, postcode=postcode).exists():
        ...
        self.stdout.write(self.style.SUCCESS("경찰서 데이터 저장 완료"))
